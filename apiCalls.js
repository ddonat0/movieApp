...
function getMovie() {
    ...
    let apiKey = '8a624efe'
    let apiKey2 = '9c4e939d595025072865984402123836'
    let movieObj = {}
    ...
    if(movieTitle == "" || apiKey == "" || apiKey2 == "") { // cannot leave any fields blank (NOTE: HTML "required" attribute only works with submit)
        ...
        nodeList = document.getElementsByClassName("card-holder") // make everything show up and undo opacity
        for(i=0; i < nodeList.length; i++) {
            nodeList[i].style.opacity = '1.0'
        }
        ...
        .then(data => { // let's render the movie details to the upper portion of the page
            ...
            document.getElementById('output-title').innerHTML = data.title
            ...
            for(i=0; i<3; i++) {
                elementId1 = 'reviewer-icon' + String(i+1)
                elementId2 = 'output-source' + String(i+1)
                if(document.getElementById(elementId2).innerHTML == "<b>Source: </b>Internet Movie Database") {
                    document.getElementById(elementId1).src = "./assets/imdb.png"
                } else if(document.getElementById(elementId2).innerHTML == "<b>Source: </b>Rotten Tomatoes") {
                    document.getElementById(elementId1).src = "./assets/rottentomatoes.png"
                } else if(document.getElementById(elementId2).innerHTML == "<b>Source: </b>Metacritic") {
                    document.getElementById(elementId1).src = "./assets/metacritic.png"
                } else {
                    document.getElementById(elementId1).src = "..."
                }
            }
